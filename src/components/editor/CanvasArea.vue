        ...
        <div class="image-wrapper" @click="onCanvasClick"
          ...
          <svg ref="svgOverlay" class="overlay-layer" viewBox="0 0 100 100" preserveAspectRatio="none">
            <defs>
              ...
              <clipPath v-for="entity in store.entities.filter(e => e.type === 'light')" :key="'clip-' + entity.id"
            ...
            <template v-for="entity in store.entities.filter(e => e.type === 'light')" :key="'outline-' + entity.id">
            ...
            <!-- Vertex Handles -->
            <template v-for="entity in store.entities.filter(e => e.type === 'light')" :key="'handles-' + entity.id">
